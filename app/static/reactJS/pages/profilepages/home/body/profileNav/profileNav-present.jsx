        ...
        <div className={styles.profileNav}>
            <div className={styles.panel}>
                <Nav pills={true} vertical={true} className={styles.navList}>
                    <li onClick={() => props.handleActiveTab('projectfeed')} onMouseEnter={() => props.handleNavHover('projectfeed')} onMouseLeave={() => props.handleNavHover(false)} style={(props.activeTab === 'projectfeed' || props.hoverTab === 'projectfeed') ? ActiveTab : {}}><a><i className="fa fa-info-circle"/>Latest Project Updates</a></li>
