        ...
        return (
            <div>
                {(loading || stripeLoading)
                    ? <PriceBtn className="btn btn-block btn-primary text-uppercase">processing..</PriceBtn>
                    : <PriceBtn className="btn btn-block btn-primary text-uppercase"
                            onClick={this.onStripeUpdate}
                            style={this.state.sub_style}
                            disabled={this.state.sub_btn}>{this.state.sub_text}</PriceBtn>
                }
            </div>
        );
    }
