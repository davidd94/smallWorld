...
export class HuluBox extends Component {
    render() {
        return (
                    ...
                    <Rightbox className="rightbox">
                        <TabStyles className="profile" style={{opacity: 1, zIndex: 500}}>
                            ...
                            <TabSubTitle className="personal-info-title username">User Name</TabSubTitle>
                                <TabSubTitle2 className="personal-info username-value">{this.props.username}</TabSubTitle2>
                            <TabSubTitle className="personal-info-title firstname">First Name</TabSubTitle>
                                <TabSubTitle2 className="personal-info firstname-value">{this.props.firstname}</TabSubTitle2>
                            <TabSubTitle className="personal-info-title lastname">Last Name</TabSubTitle>
                                <TabSubTitle2 className="personal-info lastname-value">{this.props.lastname}</TabSubTitle2>
                            <TabSubTitle className="personal-info-title email">Email</TabSubTitle>
                                <TabSubTitle2 className="personal-info email-value">{this.props.email} <a href="/edit_profile" style={{cursor: "pointer"}}><HuluBtn className="btn privacy-btn email-btn">Update</HuluBtn></a></TabSubTitle2>
                            <TabSubTitle className="personal-info-title password">Password </TabSubTitle>
                                <TabSubTitle2 className="personal-info password-value">••••••• <a href="/edit_profile" style={{cursor: "pointer"}}><HuluBtn className="btn privacy-btn pw-btn">Change</HuluBtn></a></TabSubTitle2>
                        </TabStyles>
                        ...
                        <TabStyles className="payment-wrapper">
                            ...
                            <TabStyles2 className="payment">
                                ...
                                <TabSubTitle className="payment-info-title">Payment Method</TabSubTitle>
                                    <TabSubTitle2 className="payment-info">Mastercard •••• •••• •••• 0000 <HuluBtn className="btn privacy-btn">update</HuluBtn></TabSubTitle2>
                                <TabSubTitle className="payment-info-title">Billing Address</TabSubTitle>
                                    <TabSubTitle2 className="payment-info">1234 Example Ave | Seattle, WA <HuluBtn className="btn privacy-btn">change</HuluBtn></TabSubTitle2>
                                ...
                                <TabSubTitle className="payment-info-title">Billing History</TabSubTitle>
                                    <TabSubTitle2 className="payment-info">2018<HuluBtn className="btn privacy-btn">view</HuluBtn></TabSubTitle2>
                                <TabSubTitle2 className="payment-info-title">Redeem Gift Subscription </TabSubTitle2>
                                <TabSubTitle2 className="payment-info"><GiftInput type="text" className="gift-card-input" placeholder="Enter Gift Code"></GiftInput> <HuluBtn className="btn privacy-btn">Redeem</HuluBtn></TabSubTitle2>
                            </TabStyles2>
                        </TabStyles>
                        ...
                        <TabStyles className="subscription-wrapper">
                            ...
                            <TabStyles2 className="subscription">
                                ...
                                <TabSubTitle className="subscription-info-title">Payment Date</TabSubTitle>
                                    <TabSubTitle2 className="subscription-info">05-15-2018 <HuluBtn className="btn privacy-btn">pay now</HuluBtn></TabSubTitle2>
                                ...
                                <TabSubTitle className="subscription-info-title">Hulu Base Plan</TabSubTitle>
                                    <TabSubTitle2 className="subscription-info">Limited Commercials <HuluBtn className="btn privacy-btn">change plan</HuluBtn></TabSubTitle2>
                                <TabSubTitle className="subscription-info-title">Add-ons</TabSubTitle>
                                    <TabSubTitle2 className="subscription-info">None <HuluBtn className="btn privacy-btn">manage</HuluBtn></TabSubTitle2>
                        ...
                        <TabStyles className="privacy">
                            ...
                            <TabSubTitle className="privacy-info-title" style={{marginTop: "25px"}}>Manage Email Notifications<HuluBtn className="btn privacy-btn" data-toggle="modal" data-target="#modalNote">manage</HuluBtn></TabSubTitle>
                            <TabSubTitle2 className="privacy-info"></TabSubTitle2>
                            <TabSubTitle className="privacy-info-title" style={{marginTop: "25px"}}>View Terms of Use <HuluBtn className="btn privacy-btn">view</HuluBtn></TabSubTitle>
                            <TabSubTitle2 className="privacy-info"></TabSubTitle2>
                            <TabSubTitle className="privacy-info-title" style={{marginTop: "25px"}}>Protect Your Account <HuluBtn className="btn privacy-btn">protect</HuluBtn></TabSubTitle>
                            <TabSubTitle2 className="privacy-info"></TabSubTitle2>
                        </TabStyles>
                        <TabStyles className="settings">
                            <TabTitle>Account Settings</TabTitle>
                            <TabSubTitle className="settings-info-title" style={{marginTop: "25px"}}>Hold Your Subscription<HuluBtn className="btn privacy-btn">hold</HuluBtn></TabSubTitle>
                            <TabSubTitle2 className="settings-info"></TabSubTitle2>
                            <TabSubTitle className="settings-info-title" style={{marginTop: "25px"}}>Cancel Your Subscription <HuluBtn className="btn privacy-btn">cancel</HuluBtn></TabSubTitle>
                            <TabSubTitle2 className="settings-info"></TabSubTitle2>
                            <TabSubTitle className="settings-info-title" style={{marginTop: "25px"}}>Account Status <HuluBtn id="privacy-deactivate" className="btn privacy-btn" data-toggle="modal" data-target="#modalDel">DEACTIVATE</HuluBtn></TabSubTitle>
                            <TabSubTitle2 className="settings-info"></TabSubTitle2>
                        </TabStyles>
                    </Rightbox>
                </HuluContainer>
